...
<html>
    ...
    <head>
        ...
        <link href="../../public/admin/assets/plugins/datatable/dataTables.bootstrap4.min.css" rel="stylesheet" />
    ...
    <body class="app sidebar-mini rtl" >
            ...
            <div class="page-main">
                ...
                <aside class="app-sidebar ">
                    <div class="sidebar-img">
                        ...
                        <ul class="side-menu">
                            <li class="slide">
                                <a class="side-menu__item active" data-toggle="slide" href="../../admin/"><i class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Dashboard</span></a>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li>
                                        <a href="../produit/liste" class="slide-item">Liste</a>
                                    </li>
                                    <li>
                                        <a href="../produit/add" class="slide-item">Ajouter</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li>
                                        <a href="../employe/liste" class="slide-item">Liste</a>
                                    </li>
                                    <li>
                                        <a href="../employe/add" class="slide-item">Ajouter</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    <li>
                                        <a href="../equipement/list" class="slide-item">Liste</a>
                                    </li>
                                    <li>
                                        <a href="../equipement/add" class="slide-item">Ajouter</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                            ...
                            <div class="container-fluid pt-8">
                                <div class="page-header mt-0 shadow p-3">
                                    <ol class="breadcrumb mb-sm-0">
                                        <li class="breadcrumb-item"><a href="../public/admin/#" style="color: green">Acceuil</a></li>
                                    </ol>
        ...
        <!-- Optional JS -->
        <script src="../../public/admin/assets/plugins/chart.js/dist/Chart.min.js"></script>
        <script src="../../public/admin/assets/plugins/chart.js/dist/Chart.extension.js"></script>

        <!-- Data tables -->
        <script src="../../public/admin/assets/plugins/datatable/jquery.dataTables.min.js"></script>
        <script src="../../public/admin/assets/plugins/datatable/dataTables.bootstrap4.min.js"></script>
        ...
        <script>
            $(".sup").click(function () {
                ...
                swal({title: "Êtes vous sûr de supprimer ce produit ?",
            ...
            $(".supb").click(function () {
                ...
                swal({title: "Êtes vous sûr de vouloir cet équipement ?",
                    ...
                    closeOnconfirm: false
                        ...
                        function () {
                            window.location.href = "../equipement/delete/" + id;
                        }
                );
            })
        </script>
